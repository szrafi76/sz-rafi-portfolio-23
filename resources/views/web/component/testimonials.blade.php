<div class="sz_rafi_tm_section">
    <div class="sz_rafi_tm_testimonials">
        <div class="sz_rafi_tm_main_title" data-align="center">
            ...
            <div class="total">
                <div class="in">
                    <ul class="owl-carousel owl-theme">
                        <li>
                            <div class="icon">
                                <img class="svg" src="{{ asset('') }}assets/web/img/svg/testimonials/quote.svg" alt />
                            </div>
                            <div class="text">
                            ...
                            <div class="short">
                                <div class="image">
                                    <div class="main" data-img-url="{{ asset('') }}assets/web/img/testimonials/1.png"></div>
                                </div>
                                <div class="detail">
                                    <h3>Tahmid Alam</h3>
                                    <span>CTO (Akij Venture LTD.)</span>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="text">
                                <p>Really the Code Quality, Customer Support, and design are awesome and its
                                    ...
                                    Really awesome. I will strongly recommend to my friends. Simply
                                    amazing team and amazing theme! Thank you from United States of America!</p>
                            </div>
                            <div class="short">
                                <div class="image">
                                    <div class="main" data-img-url="{{ asset('') }}assets/web/img/testimonials/3.jpg"></div>
                                </div>
                                <div class="detail">
                                    <h3>Asaduzzaman Dipu</h3>
                                    <span>Manager(Akij Electricals LTD.)</span>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="text">
                                <p>Loved the template design, documentation, customizability and the customer
                                    ...
                                    knowledge about coding but the Marketify team helped me to launch
                                    my resume website successfully. Much recommended!</p>
                            </div>
                            <div class="short">
                                <div class="image">
                                    <div class="main" data-img-url="{{ asset('') }}assets/web/img/testimonials/6.jpg"></div>
                                </div>
                                <div class="detail">
                                    <h3>Tahmid Alam</h3>
                                    <span>CTO (Akij Venture LTD.)</span>
                ...
                <div class="right_details">
                    <div class="det_image one wow fadeIn" data-wow-duration="1s"
                        data-img-url="{{ asset('') }}assets/web/img/testimonials/5.jpg"></div>
                    <div class="det_image two wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s"
                        data-img-url="{{ asset('') }}assets/web/img/testimonials/6.jpg"></div>
                    <div class="det_image three wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s"
                        data-img-url="{{ asset('') }}assets/web/img/testimonials/7.jpg"></div>
                    <span class="circle yellow animPulse"></span>
        ...
        <div class="brush_1 wow fadeInRight" data-wow-duration="1s">
            <img src="{{ asset('') }}assets/web/img/brushes/testimonials/1.png" alt />
        </div>
    </div>
</div>
